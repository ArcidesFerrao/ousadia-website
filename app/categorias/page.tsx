  ...
  return (
    <>
      ...
      <div className="bg0 m-t-23 p-b-140">
        <div className="container ">
          <div className="p-b-10" id="shetas">
            <h3 className="ltext-103 cl5">Shetas</h3>
          </div>
          ...
          <div className="p-b-10" id="bones">
            <h3 className="ltext-103 cl5">Bones</h3>
          </div>
          <div className="row isotope-grid">
            <div className="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
              {/* Block2 */}
          ...
          <div className="p-b-10" id="collabs">
            <h3 className="ltext-103 cl5">Collabs</h3>
          </div>
          <div className="row isotope-grid">
            <div className="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
              {/* Block2 */}
